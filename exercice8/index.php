            ...
            <div class="col-3">
                <div class="card border-primary mb-3" style="max-width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Afficher la date du jour - 22 jours.</p>                  
                    </div>
                </div>
            </div>  
        </div>
        <div class="row justify-content-center">
            <div class="col-3">
                <div class="card text-white bg-secondary mb-3" style="max-width: 20rem;">
                    <div class="card-header">Partie 9 - Exercice 8</div>
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            echo 'Aujourd\'hui, nous sommes le ' . dateToFrench('now', 'l j F Y.') . '<br/> Il y a 22 jours, nous étions le ' . dateToFrench('- 22 days', 'l j F Y.');
                            ?>
                        </p>
                        <!-- Seconde façon :
                        $value = date('d-m-Y', strtotime('- 22 days'));
                        echo 'Il y a 22 jours, nous étions le '.$value.'.';
                        -->
                    </div>
                </div>
            </div>
