    ...
    <body>  
        ...
        <div class="row justify-content-center">
            <div class="card border-primary mb-3" style="max-width: 20rem;">
                <div class="card-header">Partie 9 - Exercice 3</div>
                <div class="card-body">
                    <h4 class="card-title">Consigne</h4>
                    <p class="card-text">Afficher la date courante avec le jour de la semaine et le mois en toutes lettres (ex : mardi 2 août 2016)</p
                    <p> <span>Bonus</span> : Le faire en français.</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="card text-white bg-secondary mb-3" style="max-width: 20rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <?php
                        //setlocale = Définit les informations de localisation. 
                        //LC_TIME pour le format de date.
                        //strftime () Formate une date/heure locale avec la configuration locale.
                        setlocale(LC_TIME, 'fr_FR.utf8');
                        //'%A', nom complet du jour de la semaine. '%d', jour du mois. '%B', nom complet du mois. '%Y', l'année, sur 4 chiffres.
