    ...
    <body> 
        ...
        <div class="row justify-content-center">
            <div class="card border-primary mb-3" style="max-width: 20rem;">
                <div class="card-header">Partie 9 - Exercice 1</div>
                <div class="card-body">
                    <h4 class="card-title">Consigne</h4>
                    <p class="card-text">Afficher la date courante en respectant la forme jj/mm/aaaa (ex : 16/05/2016)</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="card text-white bg-secondary mb-3" style="max-width: 20rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <?php
                        //pour afficher la date du jour d = day, m = month, Y = year (le y en majuscule pour avoir l'année complète), séparés par /.
